...
public class OnePassMapper extends MapFunction {
	...
	public void open(Configuration parameters) {
		emaxClusterSize = Double.parseDouble(parameters.getString(
				maxClusterSize, "1.1"));
		efacilityCostIncrement = Double.parseDouble(parameters.getString(
				facilityCostIncrement, "0.1"));
		ekappa = parameters.getInteger(kappa, 1);

		esearcherTechnique = Integer.parseInt(parameters.getString(
				searcherTechnique, "0"));
		edistanceTechnique = Integer.parseInt(parameters.getString(
				distanceTechnique, "0"));
		enumProjections = Integer.parseInt(parameters.getString(numProjections,
				"0"));
		...
		sk = new SKMeans(searcher, ekappa, emaxClusterSize,
				efacilityCostIncrement);
	...
	public void map(Record record, Collector<Record> collector) {
		...
		System.out.println("mapper: " + count + " finished in " + totalTime
				+ " ms");
	}
