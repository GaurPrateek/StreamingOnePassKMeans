...
public class OnePassPlan implements Program, ProgramDescription {
	...
	public Plan getPlan(String... args) {
		...
		MapOperator dfMapper = MapOperator.builder(OnePassMapper.class)
				.input(source).name("Onepass Mapper").build();
		...
		ReduceOperator dfReducer = ReduceOperator
				.builder(OnePassReducer.class, IntValue.class, 0)
				.input(dfMapper).name("Iterative Reducer").build();
		...
		FileDataSink sink = new FileDataSink(CsvOutputFormat.class, outputPath,
				dfReducer, "Centers");
	...
	public static void main(String[] args) {
		...
		Plan toExecute = new OnePassPlan().getPlan(args[0], args[1], args[2],
